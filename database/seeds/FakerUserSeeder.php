    ...
    public function run()
    {
        ...
        DB::table('users')->insert([
            ...
            [
                ...
                BlameColumn::CREATED_AT => '2014-01-11 22:72:05',
                BlameColumn::UPDATED_BY => 1,
                BlameColumn::CREATED_AT => '2014-02-10 23:59:59',
                BlameColumn::DELETED_BY => null,
                BlameColumn::DELETED_AT => null,
            ],
            [
                'status' => UserStatus::BLOCKED,
                'username' => 'speedy@gonzalez.com',
                'password' => randomHashing(),
                'type' => User::class,
                BlameColumn::CREATED_BY => 1,
                BlameColumn::CREATED_AT => '2016-09-20 08:59:00',
                BlameColumn::UPDATED_BY => 2,
                BlameColumn::CREATED_AT => '2017-02-10 23:59:59',
                BlameColumn::DELETED_BY => null,
                BlameColumn::DELETED_AT => null,
            ],
            [
                ...
                BlameColumn::UPDATED_BY => 1,
                BlameColumn::CREATED_AT => '2017-12-10 23:59:59',
